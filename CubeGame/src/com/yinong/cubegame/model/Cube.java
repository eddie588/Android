	...
	public static int CUBE_BOTTOM = 5;
	 ...
	 private FloatBuffer mVertexBuffer;
	    ...
	    public Cube(float x,float y,float z,float size) {
	    	...
	    	setDefaultColor(0.8f, 0.8f, 0.8f, 0.5f);
            setupBuffer();    
	    }
	    ...
	    public Triangle[] getTriangles() {
	    	...
	    	for(int i=0;i<verticesTemplate.length;i+=9) {
	    		triangle[i/9] = new Triangle(
	    			new Vect3D(verticesTemplate[i],verticesTemplate[i+1],verticesTemplate[i+2]),
	    			new Vect3D(verticesTemplate[i+3],verticesTemplate[i+4],verticesTemplate[i+5]),
	    			new Vect3D(verticesTemplate[i+6],verticesTemplate[i+7],verticesTemplate[i+8])
	    		);
